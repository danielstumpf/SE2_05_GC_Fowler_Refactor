...
public class RegularPriceTest {
	...
	public void testGetPriceCode() {
		...
		assertThat("Should return th value 0", getRegularPrice, is(0));
	}
	...
	public void testGetCharge_mitEins() {
		...
		assertThat("Should return th value 2", getRegularPrice, is(2.0));
	}
	...
	public void testGetCharge_mitVier() {
		...
		assertThat("Should return th value 3", getRegularPrice, is(3.0));
	}
	...
	public void testGetFrequentRenterPoints() {
		...
		assertThat("Should return th value 1", getRegularPrice, is(1));
	}
